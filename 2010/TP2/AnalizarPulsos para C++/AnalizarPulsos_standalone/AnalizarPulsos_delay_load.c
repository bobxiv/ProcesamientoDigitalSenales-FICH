 ...
 */
FARPROC WINAPI AnalizarPulsosDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = AnalizarPulsosDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = AnalizarPulsosDelayLoadWin32FailureHook;
#endif
